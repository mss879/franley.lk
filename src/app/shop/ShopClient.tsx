  ...
  return (
    <div className="w-full min-h-screen bg-[#fdfcf9] flex flex-col font-outfit select-none relative pb-28 md:pb-16">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 lg:px-8 mt-16 mb-8 relative z-20">
        ...
        <div 
          className="absolute inset-x-6 lg:inset-x-8 top-0 bottom-0 bg-[#7b0323] rounded-[2.2rem] md:rounded-[3.2rem] translate-y-2.5"
        />
        
        {/* Main Card Shape Front Face */}
        <footer className="relative bg-white/95 backdrop-blur-2xl border-[3px] sm:border-[4px] border-[#7b0323] rounded-[2.2rem] md:rounded-[3.2rem] text-zinc-655 px-6 sm:px-10 py-12 md:py-16 flex flex-col gap-10 md:gap-12 overflow-hidden shadow-[0_12px_24px_rgba(0,0,0,0.08)] z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 relative z-10 text-left">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                <Image src="/franley_logo_no_text_transparent.png" alt="Franley Logo" width={120} height={32} style={{ objectFit: "contain" }} />
              </div>
            ...
            <div className="flex flex-col gap-4 text-left">
              ...
              <ul className="flex flex-col gap-2.5 text-xs sm:text-sm font-semibold">
                {[
                  ...
                  <li key={item.name}>
                    <Link href={item.link} className="text-zinc-655 hover:text-[#7b0323] transition-colors duration-200">
                      {item.name}
                    </Link>
                  </li>
                ))}
          ...
          <div className="border-t border-zinc-200/80 pt-8 mt-4 flex flex-col sm:flex-row justify-between items-center gap-4 relative z-10 text-[10px] sm:text-xs font-bold tracking-wider text-zinc-450 text-left">
            ...
            <div className="flex gap-6">
              <Link href="/privacy-policy" className="hover:text-[#7b0323] transition-colors duration-200">PRIVACY POLICY</Link>
              <Link href="/refund-policy" className="hover:text-[#7b0323] transition-colors duration-200">REFUND POLICY</Link>
              <a href="#" className="hover:text-[#7b0323] transition-colors duration-200">SITEMAP</a>
            </div>
          </div>
