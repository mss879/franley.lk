    ...
    const onScroll = () => {
      ...
      raf = requestAnimationFrame(() => {
        ...
        if (!reduce && y < window.innerHeight) {
          if (blob1.current) blob1.current.style.transform = `translate3d(0, ${y * 0.18}px, 0)`;
          ...
          if (heroContent.current) {
            heroContent.current.style.transform = `translate3d(0, ${y * 0.12}px, 0)`;
            heroContent.current.style.opacity = `${Math.max(1 - y / (window.innerHeight * 0.8), 0)}`;
          }
        }
      });
    };
  ...
  return (
    <div className="relative bg-[#fdfcf9] text-zinc-900 font-outfit overflow-x-clip min-h-screen flex flex-col justify-between">
      ...
      <div className="flex-grow">
        {/* ===================== HERO SECTION ===================== */}
        <section className="relative min-h-[90vh] flex items-center overflow-hidden border-b border-zinc-200/40">
          ...
          <div ref={heroContent} className="relative z-10 max-w-5xl mx-auto px-6 md:px-8 w-full pt-32 pb-24 text-left">
            <nav className="mb-8 text-xs font-black tracking-[0.25em] text-[#7b0323] uppercase">
            ...
            <div className="inline-flex items-center gap-2 mb-8 rounded-full border border-[#7b0323]/15 bg-white/75 backdrop-blur-md px-5 py-2 shadow-sm">
              <span className="w-2 h-2 rounded-full bg-[#7b0323] animate-glow" />
              <span className="text-xs font-bold tracking-[0.22em] uppercase text-[#7b0323]">
                EST. 2026 · Colombo, Sri Lanka
              </span>
            </div>

            <h1 className="font-playfair text-4xl sm:text-6xl md:text-7xl font-normal tracking-tight leading-[1.08] mb-10 text-zinc-950">
              Timeless Accessories For The <br />
              <span className="font-extrabold italic bg-gradient-to-r from-[#7b0323] via-[#d4af37] to-[#7b0323] bg-clip-text text-transparent">
                Modern Gentleman
              </span>
            </h1>

            <p className="text-zinc-800 text-lg sm:text-xl md:text-2xl font-normal max-w-4xl leading-relaxed font-outfit border-l-4 border-[#7b0323] pl-6 md:pl-8 py-3 bg-[#7b0323]/[0.01] rounded-r-xl">
            ...
            <div className="mt-14 flex flex-wrap items-center gap-5">
              <Link
                href="/shop"
                className="group relative inline-flex items-center gap-2.5 overflow-hidden rounded-lg bg-[#7b0323] hover:bg-[#8e1534] px-10 py-5 text-sm font-black tracking-widest text-white transition-all duration-300 shadow-lg shadow-[#7b0323]/15 active:scale-[0.97] border border-[#d4af37]/20"
              >
                <span className="card-shine absolute inset-0 -translate-x-[130%] bg-gradient-to-r from-transparent via-white/20 to-transparent" />
                <span className="relative">BROWSE THE COLLECTION</span>
              </Link>
              <Link
                href="/contact"
                className="inline-flex items-center gap-2.5 rounded-lg border border-zinc-300 hover:border-[#7b0323]/30 bg-white px-10 py-5 text-sm font-black tracking-widest text-zinc-800 transition-colors duration-300 shadow-sm"
              >
                GET IN TOUCH
              </Link>
            </div>
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-1.5 opacity-60">
            ...
            <svg className="w-5 h-5 text-[#7b0323] animate-bob" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
        ...
        {/* ===================== TRUST PILLARS BAR ===================== */}
        <section className="relative bg-white border-b border-zinc-200/50 py-10 shadow-sm">
          <div className="max-w-6xl mx-auto px-6 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              {[
                {
                  label: "FAST ISLANDWIDE DELIVERY",
                  desc: "Dispatched promptly across Sri Lanka with standard tracking.",
                  icon: (
                    <svg className="w-6 h-6 text-[#7b0323]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                ...
                },
                {
                  ...
                  desc: "100% encrypted checkout process keeping your transactions safe.",
                  icon: (
                    <svg className="w-6 h-6 text-[#7b0323]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                ...
                },
                {
                  ...
                  desc: "Instant customer service and personal style guidance on demand.",
                  icon: (
                    <svg className="w-6 h-6 text-[#7b0323]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                ...
                <Reveal key={item.label} variant="up" delay={i * 100}>
                  <div className="flex items-start gap-5 justify-center md:justify-start px-4">
                    <div className="w-12 h-12 rounded-full bg-[#7b0323]/5 flex items-center justify-center border border-[#7b0323]/10 shrink-0">
                      {item.icon}
                    </div>
                    <div className="text-left">
                      <h4 className="text-xs font-black tracking-widest text-[#7b0323] uppercase">
                        {item.label}
                      </h4>
                      <p className="text-sm text-zinc-600 font-semibold font-outfit mt-1.5 leading-relaxed">
                        {item.desc}
                      </p>
                    </div>
                  </div>
        ...
        <section className="relative max-w-6xl mx-auto px-6 md:px-8 py-24 md:py-32 border-b border-zinc-200/30">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
            <div className="md:col-span-4">
              <Reveal variant="left">
                <div className="md:sticky md:top-28 text-left">
                  <span className="text-xs font-black tracking-[0.25em] text-[#7b0323] uppercase block mb-3 font-outfit">
                    / OUR CREDO
                  </span>
                  <h2 className="font-playfair text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-[1.15] text-zinc-950">
                    We believe confidence is in the details.
                  </h2>
                </div>
              </Reveal>
            </div>
            <div className="md:col-span-8 text-left flex flex-col gap-10 text-zinc-700 leading-relaxed font-outfit">
              <Reveal variant="up" delay={100}>
                <p className="text-zinc-800 text-lg sm:text-xl md:text-2xl font-normal leading-relaxed border-l-4 border-[#d4af37] pl-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 pt-6">
                {[
                  ...
                  <Reveal key={val.title} variant="up" delay={150 + idx * 100}>
                    <div className="bg-[#faf9f6] border border-zinc-200/50 p-6 rounded-2xl relative group hover:border-[#d4af37]/40 transition-all duration-300 h-full flex flex-col justify-between">
                      <div>
                        <span className="text-xs font-black text-[#7b0323] block mb-4 font-outfit tracking-wider">{val.num}</span>
                        <h4 className="text-sm font-black uppercase tracking-widest text-zinc-900 mb-3 font-outfit">{val.title}</h4>
        ...
        <section className="relative max-w-6xl mx-auto px-6 md:px-8 py-24 md:py-32">
          <Reveal variant="up">
            <div className="mb-16 text-left">
              <span className="text-xs font-black tracking-[0.25em] text-[#7b0323] uppercase block mb-3 font-outfit">
                / DRESS SHARP WITH EASE
              </span>
              <h2 className="font-playfair text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-zinc-950">
                Whether it’s for work, weddings, or gifting, FRANLEY is here to help you dress sharp with ease.
              </h2>
            </div>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Reveal key={p.title} variant="scale" delay={i * 120}>
                <div className={`group relative h-full overflow-hidden rounded-2xl border ${p.accent} bg-white p-8 flex flex-col justify-between transition-all duration-500 hover:shadow-xl hover:-translate-y-1.5`}>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-8">
                      <span className="font-playfair text-3xl font-bold italic text-[#7b0323]">{p.num}</span>
                      <span className="text-[10px] font-black tracking-widest text-zinc-400 uppercase font-outfit">FRANLEY LUXE</span>
                    </div>
                    <h3 className="font-playfair text-xl font-bold text-zinc-950 mb-4 tracking-tight">
                      {p.title}
                    </h3>
                    <p className="text-sm text-zinc-600 leading-relaxed font-medium font-outfit">{p.desc}</p>
                  </div>
                  <div className="flex items-center gap-2 text-[10px] font-black text-zinc-950 uppercase tracking-widest border-t border-zinc-200/50 pt-6 mt-10 group-hover:text-[#7b0323] transition-colors duration-300 font-outfit">
        ...
        <section className="relative max-w-5xl mx-auto px-6 md:px-8 pb-28">
          <Reveal variant="scale">
            <div className="bg-[#0c0c0c] border border-zinc-900 rounded-[2.5rem] p-8 md:p-20 text-center flex flex-col items-center justify-center relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 max-w-xl flex flex-col items-center gap-6">
                <span className="text-[10px] font-black tracking-[0.3em] text-[#d4af37] uppercase font-outfit">
                  THE SARTORIAL BLUEPRINT
                </span>
                <h2 className="font-playfair text-3xl md:text-5xl font-normal text-white tracking-tight leading-tight">
                  Step Into the World of <span className="italic">Franley</span>
                </h2>
                <p className="text-white/80 text-sm md:text-base leading-relaxed font-outfit max-w-md">
                  Upgrade your daily style, discover handcrafted mulberry silk ties, designer cufflinks, and luxury leather accessories.
                </p>
                <div className="mt-6">
                  <Link
                    href="/shop"
                    className="inline-flex items-center gap-2.5 rounded-lg bg-[#7b0323] hover:bg-[#8e1534] text-white border border-[#d4af37]/20 hover:border-[#d4af37]/50 px-10 py-5 text-sm font-black tracking-[0.2em] uppercase transition-all duration-300 shadow-md shadow-[#7b0323]/15 active:scale-[0.98]"
                  >
